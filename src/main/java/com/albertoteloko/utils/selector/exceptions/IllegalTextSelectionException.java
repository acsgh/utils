 ...
 */
public class IllegalTextSelectionException extends RuntimeException {

    /**
     * The serial version UID
     */
    private static final long serialVersionUID = -8438801344600272517L;

    /**
     * Constructs an IllegalTextSelectionException with no detail message.
     */
    public IllegalTextSelectionException() {
        super();
    }
     ...
     */
    public IllegalTextSelectionException(String message) {
        super(message);
     ...
     */
    public IllegalTextSelectionException(Throwable cause) {
        super(cause);
     ...
     *                 value is permitted, and indicates that the cause is nonexistent or unknown.)
     */
    public IllegalTextSelectionException(String message, Throwable cause) {
        super(message, cause);
        CheckUtils.checkNull("cause", cause);
        CheckUtils.checkString("message", message);
    }
