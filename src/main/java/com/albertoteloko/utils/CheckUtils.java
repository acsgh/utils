...
/**
 * This util class was written to export all the common check and all the method preconditions.
 * 
 */
public final class CheckUtils {
	...
	/**
	 * Check one object. <br>
	 * And if it is null an exception will be throw.
	 * 
	 * @param name The param name.
	 * @param value The param value.
	 * @throws NullPointerException If the name is null, If the value is null.
	 */
	public static void checkNull(String name, Object value) {
		if (value == null) {
			throw new NullPointerException("The param with name " + name + " can't have a null value.");
		}
	}

	/**
	 * Check one string. <br>
	 * And if it is null or empty an exception will be throw.
	 * 
	 * @param name The param name.
	 * @param value The param value.
	 * @throws NullPointerException If the name is null, If the value is null.
	 * @throws IllegalArgumentException If the name is empty, If the value is empty.
	 */
	...
	/**
	 * Check one string. And if it doesn't satisfy the condition an exception will be throw.
	 * 
	 * @param name The param name.
	 * @param value The param value.
	 * @param canBeNull True the string can be null, false It can't.
	 * @param canBeEmpty True the string can be empty, false It can't.
	 * @throws NullPointerException If the name is null, If the value can't be null and is null.
	 * @throws IllegalArgumentException If the name is empty, If the value can't be empty and is empty.
	 */
	public static void checkString(String name, String value, boolean canBeNull, boolean canBeEmpty) {
		...
		if ((!canBeEmpty) && (value != null) && (value.isEmpty())) {
			throw new IllegalArgumentException("The param with name: '" + name + "' can't be empty.");
		}
	}

	/**
	 * Check one string. <br>
	 * And if it is null or not match the pattern an exception will be throw.
	 * 
	 * @param name The param name.
	 * @param value The param value.
	 * @param pattern The pattern value.
	 * @throws NullPointerException If the name is null, If the value is null, If the pattern is null.
	 * @throws IllegalArgumentException If the name is empty, If the value doesn't match the pattern.
	 */
	 ...
	 * @param name The param name.
	 * @param value The param value.
	 * @param maxName The name of the min param
	 * @param max The min value allowed to this param.
	 * @throws IllegalArgumentException If the param is not included in the interval.
	 */
	 ...
	 * @param value The param value.
	 * @param min The min value allowed to this param.
	 * @param minName The name of the min param
	 * @param max The max value allowed to this param.
	 * @param maxName The name of the max param
	 * @throws IllegalArgumentException If the param is not included in the interval.
	 */
